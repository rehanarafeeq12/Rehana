# Generated by Django 5.0.1 on 2024-04-05 06:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Contest_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yeaR', to='Fest_app.year')),
            ],
        ),
        migrations.CreateModel(
            name='programmes',
            fields=[
                ...
                ('Contest_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Yr', to='Fest_app.year')),
            ],
        ),
        migrations.CreateModel(
            name='judges',
        ...
        migrations.AddField(
            model_name='contest',
            name='Contest_year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='YEAR', to='Fest_app.year'),
        ),
        migrations.CreateModel(
            name='volunteers',
            fields=[
                ...
                ('Contest_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yEAR', to='Fest_app.year')),
                ('Name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Fest_app.student')),
            ],
        ),
        migrations.AddField(
            model_name='student',
            name='Academic_year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Fest_app.year'),
        ),
        migrations.AddField(
            model_name='student',
            name='School_Name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Fest_app.school'),
        ),
        migrations.CreateModel(
            name='result',
            fields=[
                ...
                ('Contest_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Yea', to='Fest_app.year')),
                ('First', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='first', to='Fest_app.student')),
                ('Second', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='second', to='Fest_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='performer',
            fields=[
                ...
                ('Contest_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='y', to='Fest_app.year')),
                ('Performer_Names', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Fest_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='participant',
